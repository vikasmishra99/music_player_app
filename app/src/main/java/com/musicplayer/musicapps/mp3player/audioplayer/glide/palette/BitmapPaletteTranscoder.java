package com.musicplayer.musicapps.mp3player.audioplayer.glide.palette;
...
public class BitmapPaletteTranscoder implements ResourceTranscoder<Bitmap, BitmapPaletteWrapper> {
    ...
    @Override
    public String getId() {
        return "BitmapPaletteTranscoder.com.musicplayer.musicapps.mp3player.audioplayer.glide.palette";
    }
}