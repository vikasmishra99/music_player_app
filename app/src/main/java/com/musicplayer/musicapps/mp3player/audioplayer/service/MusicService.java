package com.musicplayer.musicapps.mp3player.audioplayer.service;
...
import com.musicplayer.musicapps.mp3player.audioplayer.appwidgets.AppWidgetBig;
import com.musicplayer.musicapps.mp3player.audioplayer.appwidgets.AppWidgetCard;
import com.musicplayer.musicapps.mp3player.audioplayer.appwidgets.AppWidgetClassic;
import com.musicplayer.musicapps.mp3player.audioplayer.appwidgets.AppWidgetSmall;
import com.musicplayer.musicapps.mp3player.audioplayer.glide.BlurTransformation;
import com.musicplayer.musicapps.mp3player.audioplayer.glide.SongGlideRequest;
import com.musicplayer.musicapps.mp3player.audioplayer.helper.ShuffleHelper;
import com.musicplayer.musicapps.mp3player.audioplayer.helper.StopWatch;
...
import com.musicplayer.musicapps.mp3player.audioplayer.provider.HistoryStore;
import com.musicplayer.musicapps.mp3player.audioplayer.provider.MusicPlaybackQueueStore;
import com.musicplayer.musicapps.mp3player.audioplayer.provider.SongPlayCountStore;
import com.musicplayer.musicapps.mp3player.audioplayer.service.notification.PlayingNotification;
import com.musicplayer.musicapps.mp3player.audioplayer.service.notification.PlayingNotificationImpl;
import com.musicplayer.musicapps.mp3player.audioplayer.service.notification.PlayingNotificationImpl24;
import com.musicplayer.musicapps.mp3player.audioplayer.service.playback.Playback;
...
import com.musicplayer.musicapps.mp3player.audioplayer.util.Util;
...
public class MusicService extends Service implements SharedPreferences.OnSharedPreferenceChangeListener, Playback.PlaybackCallbacks {
    ...
    public static final String X_MUSIC_PLAYER_PACKAGE_NAME = "com.musicplayer.musicapps.mp3player.audioplayer";
    public static final String MUSIC_PACKAGE_NAME = "com.android.music";

    public static final String ACTION_TOGGLE_PAUSE = X_MUSIC_PLAYER_PACKAGE_NAME + ".togglepause";
    public static final String ACTION_PLAY = X_MUSIC_PLAYER_PACKAGE_NAME + ".play";
    public static final String ACTION_PLAY_PLAYLIST = X_MUSIC_PLAYER_PACKAGE_NAME + ".play.playlist";
    public static final String ACTION_PAUSE = X_MUSIC_PLAYER_PACKAGE_NAME + ".pause";
    public static final String ACTION_STOP = X_MUSIC_PLAYER_PACKAGE_NAME + ".stop";
    public static final String ACTION_SKIP = X_MUSIC_PLAYER_PACKAGE_NAME + ".skip";
    public static final String ACTION_REWIND = X_MUSIC_PLAYER_PACKAGE_NAME + ".rewind";
    public static final String ACTION_QUIT = X_MUSIC_PLAYER_PACKAGE_NAME + ".quitservice";
    public static final String ACTION_PENDING_QUIT = X_MUSIC_PLAYER_PACKAGE_NAME + ".pendingquitservice";
    public static final String INTENT_EXTRA_PLAYLIST = X_MUSIC_PLAYER_PACKAGE_NAME + "intentextra.playlist";
    public static final String INTENT_EXTRA_SHUFFLE_MODE = X_MUSIC_PLAYER_PACKAGE_NAME + ".intentextra.shufflemode";

    public static final String APP_WIDGET_UPDATE = X_MUSIC_PLAYER_PACKAGE_NAME + ".appwidgetupdate";
    public static final String EXTRA_APP_WIDGET_NAME = X_MUSIC_PLAYER_PACKAGE_NAME + "app_widget_name";

    // do not change these three strings as it will break support with other apps (e.g. last.fm scrobbling)
    public static final String META_CHANGED = X_MUSIC_PLAYER_PACKAGE_NAME + ".metachanged";
    public static final String QUEUE_CHANGED = X_MUSIC_PLAYER_PACKAGE_NAME + ".queuechanged";
    public static final String PLAY_STATE_CHANGED = X_MUSIC_PLAYER_PACKAGE_NAME + ".playstatechanged";

    public static final String REPEAT_MODE_CHANGED = X_MUSIC_PLAYER_PACKAGE_NAME + ".repeatmodechanged";
    public static final String SHUFFLE_MODE_CHANGED = X_MUSIC_PLAYER_PACKAGE_NAME + ".shufflemodechanged";
    public static final String MEDIA_STORE_CHANGED = X_MUSIC_PLAYER_PACKAGE_NAME + ".mediastorechanged";
    ...
    public void onCreate() {
        ...
        sendBroadcast(new Intent("com.musicplayer.musicapps.mp3player.audioplayer.PHONOGRAPH_MUSIC_SERVICE_CREATED"));
    }
    ...
    public void onDestroy() {
        ...
        sendBroadcast(new Intent("com.musicplayer.musicapps.mp3player.audioplayer.PHONOGRAPH_MUSIC_SERVICE_DESTROYED"));
    }
    ...
    private void sendPublicIntent(@NonNull final String what) {
        final Intent intent = new Intent(what.replace(X_MUSIC_PLAYER_PACKAGE_NAME, MUSIC_PACKAGE_NAME));
        ...
        intent.putExtra("scrobbling_source", X_MUSIC_PLAYER_PACKAGE_NAME);
