package com.musicplayer.musicapps.mp3player.audioplayer.appshortcuts;

import android.app.Activity;
import android.content.Intent;
import android.os.Bundle;

import com.musicplayer.musicapps.mp3player.audioplayer.appshortcuts.shortcuttype.LastAddedShortcutType;
import com.musicplayer.musicapps.mp3player.audioplayer.appshortcuts.shortcuttype.ShuffleAllShortcutType;
import com.musicplayer.musicapps.mp3player.audioplayer.appshortcuts.shortcuttype.TopTracksShortcutType;
...
import com.musicplayer.musicapps.mp3player.audioplayer.model.smartplaylist.ShuffleAllPlaylist;
...
public class AppShortcutLauncherActivity extends Activity {
    public static final String KEY_SHORTCUT_TYPE = "com.musicplayer.musicapps.mp3player.audioplayer.appshortcuts.ShortcutType";
