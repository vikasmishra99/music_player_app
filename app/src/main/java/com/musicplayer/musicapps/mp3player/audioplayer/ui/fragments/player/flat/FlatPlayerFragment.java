package com.musicplayer.musicapps.mp3player.audioplayer.ui.fragments.player.flat;
...
import com.musicplayer.musicapps.mp3player.audioplayer.adapter.base.MediaEntryViewHolder;
import com.musicplayer.musicapps.mp3player.audioplayer.adapter.song.PlayingQueueAdapter;
import com.musicplayer.musicapps.mp3player.audioplayer.dialogs.LyricsDialog;
import com.musicplayer.musicapps.mp3player.audioplayer.dialogs.SongShareDialog;
import com.musicplayer.musicapps.mp3player.audioplayer.helper.MusicPlayerRemote;
import com.musicplayer.musicapps.mp3player.audioplayer.helper.menu.SongMenuHelper;
import com.musicplayer.musicapps.mp3player.audioplayer.model.Song;
import com.musicplayer.musicapps.mp3player.audioplayer.model.lyrics.Lyrics;
import com.musicplayer.musicapps.mp3player.audioplayer.ui.activities.base.AbsSlidingMusicPanelActivity;
import com.musicplayer.musicapps.mp3player.audioplayer.ui.fragments.player.AbsPlayerFragment;
import com.musicplayer.musicapps.mp3player.audioplayer.ui.fragments.player.PlayerAlbumCoverFragment;
import com.musicplayer.musicapps.mp3player.audioplayer.util.ImageUtil;
...
import com.musicplayer.musicapps.mp3player.audioplayer.util.ViewUtil;
import com.musicplayer.musicapps.mp3player.audioplayer.views.WidthFitSquareLayout;
...
public class FlatPlayerFragment extends AbsPlayerFragment implements PlayerAlbumCoverFragment.Callbacks, SlidingUpPanelLayout.PanelSlideListener {
    ...
    private static abstract class BaseImpl implements Impl {
        ...
        public AnimatorSet createDefaultColorChangeAnimatorSet(int newColor) {
            ...
            animatorSet.setDuration(ViewUtil.X_MUSIC_PLAYER_ANIM_TIME);
            return animatorSet;
        }
