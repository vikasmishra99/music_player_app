...
import com.musicplayer.musicapps.mp3player.audioplayer.adapter.AlbumCoverPagerAdapter;
import com.musicplayer.musicapps.mp3player.audioplayer.helper.MusicPlayerRemote;
import com.musicplayer.musicapps.mp3player.audioplayer.helper.MusicProgressViewUpdateHelper;
import com.musicplayer.musicapps.mp3player.audioplayer.misc.SimpleAnimatorListener;
import com.musicplayer.musicapps.mp3player.audioplayer.model.lyrics.AbsSynchronizedLyrics;
...
public class PlayerAlbumCoverFragment extends AbsMusicServiceFragment implements ViewPager.OnPageChangeListener, MusicProgressViewUpdateHelper.Callback {
    ...
    public void showHeartAnimation() {
        ...
        favoriteIcon.animate()
                .setDuration(ViewUtil.X_MUSIC_PLAYER_ANIM_TIME / 2)
