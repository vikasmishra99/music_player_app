...
import com.musicplayer.musicapps.mp3player.audioplayer.dialogs.DonationsDialog;
import com.musicplayer.musicapps.mp3player.audioplayer.ui.activities.base.AbsBaseActivity;
import com.musicplayer.musicapps.mp3player.audioplayer.ui.activities.bugreport.BugReportActivity;
...
public class AboutActivity extends AbsBaseActivity implements View.OnClickListener {
    ...
    private static String GITHUB = "https://github.com/vikasmishra99/MusicPlayer";
    private static String GITHUB_ORIGINAL_AUTHOR = "https://github.com/kabouzeid/Phonograph";

    private static String TWITTER = "https://twitter.com/GoldsMineApps";
    private static String TWITTER_ORIGINAL_AUTHOR = "https://twitter.com/karimjabouzeid";

    private static String WEBSITE = "https://google.com/";
    private static String WEBSITE_ORIGINAL_AUTHOR = "https://kabouzeid.com/";
    private static String KARIM_GOOGLE_PLUS = "https://plus.google.com/u/0/103202379000002144026";
    ...
    @BindView(R.id.karim_abou_zeid_google_plus)
    AppCompatButton karim_abou_zeid_google_plus;
    @BindView(R.id.karim_abou_zeid_website)
    AppCompatButton karim_abou_zeid_website;
    ...
    private void setUpOnClickListeners() {
        ...
        karim_abou_zeid_google_plus.setOnClickListener(this);
        karim_abou_zeid_website.setOnClickListener(this);
    ...
    public void onClick(View v) {
        if (v == changelog) {
            ...
            intent.putExtra(Intent.EXTRA_SUBJECT, "Music Player App");
        ...
        } else if (v == karim_abou_zeid_google_plus) {
            openUrl(KARIM_GOOGLE_PLUS);
        }else if (v == karim_abou_zeid_website) {
            openUrl(WEBSITE_ORIGINAL_AUTHOR);
